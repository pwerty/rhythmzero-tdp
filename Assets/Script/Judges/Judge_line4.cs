...
public class Judge_line4 : MonoBehaviour
{
    ...
    */
...

    {
        ...
        if (Input.GetKeyDown(Line4Key))
        {

            if (Physics.Raycast(transform.position, transform.forward, out Notes_line4, Judge_5_value))
            {
                if (Notes_line4.collider.name == "note_line1(Clone)")
                {
                    JudgeA();
                    lightEffects_4line = (GameObject)Instantiate(lightEffect_4line, this.transform.position, Quaternion.Euler(effect_rotation));
                    SetCount();
                    Notes_line4.collider.gameObject.SetActive(false);
                }
            }
            else if (Physics.Raycast(transform.position, transform.forward, out Notes_line4, Judge_4_value))
            {
                if (Notes_line4.collider.name == "note_line1(Clone)")
                {
                    JudgeB();
            ...
            else if (Physics.Raycast(transform.position, transform.forward, out Notes_line4, Judge_3_value))
            {
                if (Notes_line4.collider.name == "note_line1(Clone)")
                {
                    JudgeC();
            ...
            else if (Physics.Raycast(transform.position, transform.forward, out Notes_line4, Judge_2_value))
            {
                if (Notes_line4.collider.name == "note_line1(Clone)")
                {
                    JudgeD();
            ...
            else if (Physics.Raycast(transform.position, transform.forward, out Notes_line4, Judge_1_value))
